...
public class UadyVirtualLoginTest {
  ...
  public void setUp() throws Exception {
	System.setProperty("webdriver.chrome.driver",  "C:\\Users\\leilani\\Documents\\ChromeDriver\\chromedriver.exe");
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.id("username")).sendKeys("fgff");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("fvfdb");
